...
"""
        ...
        api_defs_path = output_path.replace('tech_spec.md', 'api_definitions.json')
...
if __name__ == "__main__":
    ...
    # 创建临时报告文件用于演示
    with tempfile.NamedTemporaryFile(mode='w', suffix='.md', delete=False) as temp_report:
        temp_report.write("# Research Report\n\nThis is a sample research report.\n\n## Key Findings\n- Finding 1\n- Finding 2\n")
