...
"""
Session management for MS-Agent API Server
...
class SessionManager:
    ...
    def delete_session(self, session_id: str) -> bool:
        ...
        with self._lock:
            if session_id in self._sessions:
                ...
                if session_id in self._progress_events:
                    del self._progress_events[session_id]
                return True
        return False
    ...
    def add_progress_event(
        ...
        """Add a progress event for tracking execution progress"""
        if session_id not in self._sessions:
            return False
        
        with self._lock:
            if session_id not in self._progress_events:
            ...
            self._progress_events[session_id].append(event_with_timestamp)
    ...
    def get_progress_events(
        ...
        return [
            ...
            if event.get('timestamp', '') > after_timestamp
        ]
