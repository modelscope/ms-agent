...
class DeepResearchCaller:
    ...
    def run(self, query: str, output_dir: Path, 
        ...
        deep_research_path = Path(__file__).parent.parent / "projects" / "deep_research" / "run.py"
        ...
        try:
            ...
            return {
                ...
                'report_path': output_dir / 'report.md' if (output_dir / 'report.md').exists() else None
            }
            ...
            return {
                ...
                'returncode': -1,
                'stdout': '',
                'stderr': f'Deep Research execution timed out after {self.timeout} seconds',
                'output_dir': output_dir,
                'report_path': None
            }
